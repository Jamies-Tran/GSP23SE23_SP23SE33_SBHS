                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text("${data.homestays![index].createdDate}")
                                                                                ],
                                                                              ),
                                                                            ),
                                                                            Expanded(
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text("${data.homestays![index].availableRooms! * data.homestays![index].roomCapacity!}")
                                                                                ],
                                                                              ),
                                                                            ),
                                                                          ],
                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text("${double.parse(data.homestays![index].totalAverageRating!.toStringAsFixed(2))} (${data.homestays![index].numberOfRating})")
                                                                                ],
                                                                              ),
                                                                            ),
                                                                            Expanded(
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          streamSnapshot.data!.onCampaign(bloc: data.blocs![index])
                                                                              ? Text("-${streamSnapshot.data!.campaign(bloc: data.blocs![index])!.discountPercentage!}%", style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white, backgroundColor: primaryColor, letterSpacing: 1.0))
                                                                              : const SizedBox()
                                                                        ],
                                                                      ),
                                                                      const SizedBox(
                                                                          ...
                                                                          Expanded(
                                                                              ...
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text("${data.blocs![index].createdDate}")
                                                                                ],
                                                                              )),
                                                                          Expanded(
                                                                            flex:
                                                                            ...
                                                                            child:
                                                                                Row(
                                                                              children: [
                                                                                const Icon(Icons.holiday_village, color: Colors.amber),
                                                                                const SizedBox(width: 5),
                                                                                Text(
                                                                                  "${data.blocs![index].homestays!.length}",
                                                                                  style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                                                                                ),
                                                                              ],
                                                                            ),
